...
def get_policy(policy_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_frontdoor_v20240201:frontdoor:getPolicy', __args__, opts=opts, typ=GetPolicyResult, package_ref=_utilities.get_package()).value
...
def get_policy_output(policy_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_frontdoor_v20240201:frontdoor:getPolicy', __args__, opts=opts, typ=GetPolicyResult, package_ref=_utilities.get_package())
